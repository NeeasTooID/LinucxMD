...
const apikey = "ptla_hGCAQgYw5KAovEwV2j1fRj3wEobraUVNh6VqFI8cO2Z" // Apikey
const c_apikey = "ptlc_HjwgdPPDU94lr79L14ZCpqdRbtKD101AgxcfrviSu67" // c Apikey

    const webPage = "https://lpanel.zanixon.xyz" // Web Page
...
> Perintah : ${_p + command} nomer/tag`);
            ...
            let f = await fetch(domain + "/api/application/users", {
                ...
                "body": JSON.stringify({
                    "email": "lp-user" + profil.toString() + "@gmail.com", // Email
                    "username": "lname" + profil.toString(), // Username
                    "first_name": "lpanel" + profil.toString(), // Nama Depan
                    "last_name": "host", // Nama Belakang
                    "language": "en", // Bahasa
                    "password": "Lhosting" + password.toString() // Password
                })
            })
...
handler.help = ["addusr", "delusr", "detusr", "addsrv", "delsrv", "detsrv", "reinstall", "updatesrv", "startsrv", "stopsrv", "restartsrv"];
handler.command = ["addusr", "delusr", "detusr", "addsrv", "delsrv", "detsrv", "reinstall", "updatesrv", "startsrv", "stopsrv", "restartsrv"];
handler.tags = ["panel"]
