    ...
    const sections = [
				[
					'— LINUCXMD JOIN GROUP', [
						...
						['Harga: Rp. 5.000 IDR', '.sewa G7', '7 Day join the group']
				]], [
					'— PREMIUM USER', [
